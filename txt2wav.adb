...
procedure txt2wav is
	...
	txstr, mostr: strtype;
	lst1, lst2: natural;
	iwpm: integer; -- optional input indicating output speed
	...
	procedure mstr2wav(morsestr: string; wpm: integer) is separate;
